...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-c26ee8a4');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-c26ee8a4');}
...
var brandEl=document.querySelector('.rl-brand-c26ee8a4');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
